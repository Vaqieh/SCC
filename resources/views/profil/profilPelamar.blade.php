            ...
            <div class="card shadow-sm" style="border-radius: 15px; overflow: hidden;">
                ...
                <div class="card-body" style="padding: 30px; font-family: 'Roboto', sans-serif;">
                    ...
                    <div class="text-center mb-4">
                        <figure>
                            <img width="100" class="rounded-circle" src="{{ asset('storage/' . ($profile->foto ?? 'default.jpg')) }}" alt="Foto Profil" style="border-radius: 50%; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
                        </figure>
                    </div>
                    ...
                    <form action="{{ route('pelamar.profil.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="NamaPelamar" value="{{ old('NamaPelamar', Auth::user()->name) }}" disabled>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="TanggalLahir" value="{{ old('TanggalLahir', $profile->TanggalLahir ?? '') }}">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="Alamat" value="{{ old('Alamat', $profile->Alamat ?? '') }}">
                            </div>
                            <div class="col-md-6">
                                <label for="Kompetensi" class="form-label">Kompetensi</label>
                                <input type="text" class="form-control" name="Kompetensi" value="{{ old('Kompetensi', $profile->Kompetensi ?? '') }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                @if ($profile->sertifikat)
                                    <a href="{{ url('/file/sertifikat/' . basename($profile->sertifikat)) }}" target="_blank" class="mt-2 d-block">Lihat Sertifikat</a>
                                @endif
                            </div>
                            <div class="col-md-6">
                                <label for="instansi" class="form-label">Instansi</label>
                                <input type="text" class="form-control" name="instansi" value="{{ old('instansi', $profile->instansi ?? '') }}">
                            </div>
                        </div>

                        <div class="row mb-4">
                            <!-- Upload CV dan Foto Profil -->
                            <div class="col-md-12">
                                <label for="cv" class="form-label">Upload CV</label>
                                <input type="file" class="form-control" name="cv">
                                @if ($profile->cv)
                                    <a href="{{ url('/file/cv/' . basename($profile->cv)) }}" target="_blank" class="mt-2 d-block">Lihat CV</a>
                                @endif
                            </div>
                            <div class="col-md-12 mt-3">
                                ...
                                @if ($profile->foto)
                                    <img src="{{ asset('storage/' . $profile->foto) }}" width="100" class="mt-3">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <button type="submit" class="btn btn-primary btn-lg" style="font-weight: bold; padding: 10px 30px;">Simpan Perubahan</button>
                        </div>
                    </form>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                @if ($profile->sertifikat)
                                    <a href="{{ url('/file/sertifikat/' . basename($profile->sertifikat)) }}" target="_blank" class="btn btn-info btn-sm">Lihat Sertifikat</a>
                                @else
                            ...
                            <div class="mb-3">
                                <strong>CV:</strong>
                                @if ($profile->cv)
                                    <a href="{{ url('/file/cv/' . basename($profile->cv)) }}" target="_blank" class="btn btn-info btn-sm">Lihat CV</a>
                                @else
