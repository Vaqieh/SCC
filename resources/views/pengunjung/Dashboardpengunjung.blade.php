        ...
        <section id="hero" class="hero section">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="stat-item rounded shadow p-4 text-center" style="background-color: #f8f9fa;">
                        ...
                        <div class="stat-content">
                            ...
                            <p class="fs-6 text-muted">1200</p> <!-- Contoh angka -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="stat-item rounded shadow p-4 text-center" style="background-color: #f8f9fa;">
                        ...
                        <div class="stat-content">
                            ...
                            <p class="fs-6 text-muted">45</p> <!-- Contoh angka -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="stat-item rounded shadow p-4 text-center" style="background-color: #f8f9fa;">
                        ...
                        <div class="stat-content">
                            ...
                            <p class="fs-6 text-muted">25</p> <!-- Contoh angka -->
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="stat-item rounded shadow p-4 text-center" style="background-color: #f8f9fa;">
                        ...
                        <div class="stat-content">
                            ...
                            <p class="fs-6 text-muted">10</p> <!-- Contoh angka -->
                        </div>
                    </div>
                </div>
            </div>
            ...
            <section id="hero" class="hero section">
                <div class="container text-center"
                    ...
                    <h2 class="mb-5">Daftar Lowongan Pekerjaan</h2>

                    <!-- Grid Layout -->
                    <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
                        <!-- Card 1 -->
                        <div
                            style="border: 1px solid #ddd; border-radius: 10px; width: 220px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            ...
                            <div style="padding: 15px; text-align: center;">
                                <h4 style="margin-bottom: 10px; font-size: 18px;">
                                    <a href="detail1.html" style="text-decoration: none; color: black;">Programmer</a>
                                </h4>
                                <p style="font-size: 14px; color: #555; margin: 5px 0;">POLITEKNIK CALTEX RIAU</p>
                                <p style="font-size: 13px; color: #777; margin: 5px 0;">17 September 2024 - 13 Oktober 2024
                                </p>
                                <p style="font-size: 13px; color: #777;">Dibutuhkan: 0 orang</p>
                            </div>
                        </div>
                        ...
                        <div
                            style="border: 1px solid #ddd; border-radius: 10px; width: 220px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            <img src="iLanding/assets/img/staf_marketing.jpg" alt="Poster Staf Marketing"
                                style="width: 100%; height: 150px; object-fit: cover;">
                            <div style="padding: 15px; text-align: center;">
                                <h4 style="margin-bottom: 10px; font-size: 18px;">
                                    <a href="detail2.html" style="text-decoration: none; color: black;">Staf Marketing
                                        PCR</a>
                                </h4>
                                <p style="font-size: 14px; color: #555; margin: 5px 0;">POLITEKNIK CALTEX RIAU</p>
                                <p style="font-size: 13px; color: #777; margin: 5px 0;">17 September 2024 - 13 Oktober 2024
                        ...
                        <div
                            style="border: 1px solid #ddd; border-radius: 10px; width: 220px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                            <img src="iLanding/assets/img/administration.png" alt="Poster Staf Administrasi"
                                style="width: 100%; height: 150px; object-fit: cover;">
                            <div style="padding: 15px; text-align: center;">
                                <h4 style="margin-bottom: 10px; font-size: 18px;">
                                    <a href="detail3.html" style="text-decoration: none; color: black;">Staf
                                        Administrasi</a>
                                </h4>
                                <p style="font-size: 14px; color: #555; margin: 5px 0;">SEKOLAH TINGGI NUASANTARA</p>
                                <p style="font-size: 13px; color: #777; margin: 5px 0;">25 Juli 2024 - 01 Agustus 2024</p>
                                <p style="font-size: 13px; color: #777;">Dibutuhkan: 0 orang</p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div style="padding: 15px; text-align: center;">
                                <h4 style="margin-bottom: 10px; font-size: 18px;">
                                    <a href="detail4.html" style="text-decoration: none; color: black;">Dosen</a>
                                </h4>
                                <p style="font-size: 14px; color: #555; margin: 5px 0;">SEKOLAH TINGGI NUSANTARA</p>
                                <p style="font-size: 13px; color: #777; margin: 5px 0;">25 Juli 2024 - 01 Agustus 2024</p>
                                <p style="font-size: 13px; color: #777;">Dibutuhkan: 0 orang</p>
                            </div>
                        </div>
